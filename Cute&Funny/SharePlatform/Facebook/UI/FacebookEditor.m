...
#define FB_GrayColor [UIColor colorWithRed:85.0/255.0 green:85.0/255.0 blue:85.0/255.0 alpha:1.0]
#define FB_RedColor [UIColor colorWithRed:128.0/255.0 green:0.0 blue:0.0 alpha:1.0]
...
@interface FacebookEditor(PrivateMethods)

/*对象初始化*/
- (id)initWithFrame:(CGRect)frame type:(FBEditorType)type delegate:(id)_delegate;
...
@implementation FacebookEditor
@synthesize delegate,shareText,shareImage,shareParameters,wordsLimit;

#pragma mark - View LifeCycle
/*Editor界面*/
+ (FacebookEditor *)showInView:(UIView *)view type:(FBEditorType)type delegate:(id)_delegate{
    [FacebookEditor checkDisplayTye];
    
    FacebookEditor *editorView = [[[FacebookEditor alloc] initWithFrame:CGRectMake(0, 0, screenWidth, screenHeight) 
                                                                  type:type 
...
- (void)keyboardWillShow:(id)notification{
    ...
    FBDisplayType displayType = [FacebookEditor checkDisplayTye];
    switch (displayType) {
...
/*同步Counter字数显示*/
- (void)syncCounterDisplay{
    //self.shareText = [tbTextView getTextViewString];
    ...
    if(wordsLimit != -1 && (wordsLimit-textLength)<0)
        counterLb.textColor = FB_RedColor;
    else
        counterLb.textColor = FB_GrayColor;
...
- (void)initCoordinates{
    ...
    switch (displayType) {
        case FBDisplayIphoneLandscape:
            ...
            pannelViewImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_box_h.png" ofType:nil]];
            cancelBtFrame = CGRectMake(5, 4, 67, 33);
            cancelBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_cancel_h.png" ofType:nil]];
            sendBtFrame = CGRectMake(408, 4, 67, 33);
            sendBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_share_h.png" ofType:nil]];
            tbTextViewFrame = CGRectMake(5, 50, 470, 62);
            innerTextWidth = (editorType == FBEditorFeed)?470:392;
        ...
        case FBDisplayIphoneportrait:
            ...
            pannelViewImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_box_v.png" ofType:nil]];
            cancelBtFrame = CGRectMake(5, 4, 67, 33);
            cancelBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_cancel_v.png" ofType:nil]];
            sendBtFrame = CGRectMake(239, 4, 67, 33);
            sendBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_share_v.png" ofType:nil]];
            tbTextViewFrame = CGRectMake(5, 50, 301, 132);
            innerTextWidth = (editorType == FBEditorFeed)?301:223;
        ...
        case FBDisplayIphone5Landscape:
            ...
            pannelViewImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_box_h-i5.png" ofType:nil]];
            cancelBtFrame = CGRectMake(5, 4, 67, 33);
            cancelBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_cancel_h.png" ofType:nil]];
            sendBtFrame = CGRectMake(496, 4, 67, 33);
            sendBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_share_h.png" ofType:nil]];
            tbTextViewFrame = CGRectMake(5, 50, 558, 62);
            innerTextWidth = (editorType == FBEditorFeed)?558:480;
        ...
        case FBDisplayIpadLandscape:
            ...
            pannelViewImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_box_h.png" ofType:nil]];
            cancelBtFrame = CGRectMake(5, 4, 68, 34);
            cancelBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_cancel_h.png" ofType:nil]];
            sendBtFrame = CGRectMake(468, 4, 68, 34);
            sendBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_share_h.png" ofType:nil]];
            tbTextViewFrame = CGRectMake(5, 43, 531, 125);
            innerTextWidth = (editorType == FBEditorFeed)?531:426;
        ...
        case FBDisplayIpadportrait:
            ...
            pannelViewImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_box_v.png" ofType:nil]];
            cancelBtFrame = CGRectMake(5, 7, 68, 34);
            cancelBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_cancel_v.png" ofType:nil]];
            sendBtFrame = CGRectMake(563, 7, 68, 34);
            sendBtImg = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fb_ipad_share_v.png" ofType:nil]];
            tbTextViewFrame = CGRectMake(5, 50, 626, 145);
            innerTextWidth = (editorType == FBEditorFeed)?626:521;
...
//    switch (editorType) {
//        case FBEditorFeed:
//            [[Facebook sharedFacebook] beginPostToFeedWallWithMessage:self.shareText parameters:self.shareParameters];
//            break;
//            
//        case FBEditorUpload:
//            [[Facebook sharedFacebook] beginUploadImgWithImage:self.shareImage message:self.shareText];
//            break;
//    }
    
    [[Facebook sharedFacebook] uploadVideo:self.videoData message:self.shareText];
    
    [Facebook sharedFacebook].delegate = self;
...
- (void)fbTransactionSuccessWithKey:(NSString *)key data:(NSData *)data{
    if([key isEqualToString:FB_CallBack_FeedWall] || [key isEqualToString:FB_CallBack_UploadImage]){
        if(self.delegate && [self.delegate  respondsToSelector:@selector(fbEditorSendSuccessed:)])
            [self.delegate fbEditorSendSuccessed:data];
...
- (void)fbTransactionFailedWithKey:(NSString *)key error:(NSError *)error{
    [self endSendAnimation];
    if(self.delegate && [self.delegate  respondsToSelector:@selector(fbEditorSendFailed:)])
            [self.delegate fbEditorSendFailed:error];
    if(error.code == FB_ErrorCode_OAuth){
        [self startDismissAnimation];
    }
