...
- (RGMPageView *)pagingScrollView:(RGMPagingScrollView *)pagingScrollView viewForIndex:(NSInteger)idx;
@end
...
@property (assign, nonatomic) IBOutlet id <RGMPagingScrollViewDelegate> delegate;
@property (assign, nonatomic) IBOutlet id <RGMPagingScrollViewDatasource> datasource;
